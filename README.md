# nvim-treesitter-queries-properties

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-properties/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-properties/actions/workflows/validate.yml)

Neovim tree-sitter queries for **properties**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-properties",
...
- [ ] Changes are scoped to `properties` — do not include files for other languages
